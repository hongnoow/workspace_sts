...
public class Bank {
    ...
    Client returnClientInfo(String accNumber, String name){
        Client client;
        for(int i = 0 ; i < clientList.size() ; i++){
            if(accNumber.equals(clientList.get(i).getAccInfo().getAccNUmber())
    ...
    ArrayList<Client> returnClientList(int balance){
